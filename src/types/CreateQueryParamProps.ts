...
> = Omit<
    {
        ...
        /**
         * Deserialize a value from a parsed url urlQuery into the type of the urlQuery param.
        ...
        /**
         * Serialize a value from the urlQuery param into a parsed url urlQuery (i.e., string or array of strings).
